...
png(paste0("/home/pabloide/Documentos/3 Semestre/R_paralelo/p11/inicio_p11_frente.png"))
...
rep <- 50 # Cantidad de hijos que genera por 2
tmax <- 50 # Cantidad de generaciones
...
for (iter in 1:tmax) {
  ...
  png(paste0("/home/pabloide/Documentos/3 Semestre/R_paralelo/p11/p11_",tl,".png"))
...
system("convert -delay 30 -size 300x300 p11_*.png -loop 0 p11.gif") # creamos animacion con ImageMagick
#system("rm p11_*.png")