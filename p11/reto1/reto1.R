...
for(x in 1:n){
  ...
  png(paste0("/home/pabloide/Documentos/3 Semestre/R_paralelo/p11/tarea_y_reto1/",k,"_p11_frente_seleccionados1.png"))
  ...
  points(frente[centro,1], frente[centro,2], col="red", pch=16, cex=1.5)
  points(frente[centro_1,1], frente[centro_1,2], col="red", pch=16, cex=1.5)
  points(frente[centro_2,1], frente[centro_2,2], col="red", pch=16, cex=1.5)
