...
for(z in 1:20){
  ...
  nombre <- paste0("/home/pabloide/Documentos/3 Semestre/R_paralelo/p10/reto1/",z,"_sol_reto1_s.csv")
  write.table(sol, nombre, sep=",") 
  write.table(s_obj, "/home/pabloide/Documentos/3 Semestre/R_paralelo/p10/reto1/opt_reto1_s.csv", sep=",") 
}
